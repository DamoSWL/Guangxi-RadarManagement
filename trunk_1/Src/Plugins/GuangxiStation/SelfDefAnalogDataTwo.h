...
class CSelfDefAnalogDataTwo :public wxEvtHandler,
	public IProcess
{
public:
	CSelfDefAnalogDataTwo(void);
	virtual ~CSelfDefAnalogDataTwo(void);
...
private:
	...
	std::map<UINT,UPSSelfDefAnalogDataStructureTwo> m_UPSParam;
