...
class CSelfDefAnalogDataThree :public wxEvtHandler,
	public IProcess
{
public:
	CSelfDefAnalogDataThree(void);
	virtual ~CSelfDefAnalogDataThree(void);
...
private:
	...
	std::map<UINT,UPSSelfDefAnalogDataStructureThree> m_UPSParam;
