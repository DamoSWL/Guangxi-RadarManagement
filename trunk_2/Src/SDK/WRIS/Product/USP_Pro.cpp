...
#include "../../../include/WRIS/product/USP_pro.h"
...
int USPPro::Open(string szPath)
{
	...
	if(szPath == "")
		return 1;
	////////////////////////
	memcpy( &m_RZHeader, m_pData, sizeof(tagUSPHead) );

	m_pFData = (float *)(m_pData + sizeof(tagUSPHead));

	return 0;
}

int USPPro::OpenBuff( char *pBuff, int iLen)
{
