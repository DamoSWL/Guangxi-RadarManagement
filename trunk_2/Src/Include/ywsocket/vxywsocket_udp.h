...
#define DEF_BUFFERSIZE  6  // 缺省缓冲容器大小
/////////////////////////////////////////////////////////////////////////



//! YWSocket_UDP 远望基于Vxworks任务网络通信类
/**
...
class YWSocket_UDP
{
	...
	int m_iVxLeavePackgeSize; //! VX分包后剩余包大小
	int m_tidReceive; //! 数据接收线程的ID
